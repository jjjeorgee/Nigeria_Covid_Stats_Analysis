...
Key metrics have been noted from the available data, and Tableau dashboard containing visualizations of these metrics can be found in this [dashboard](https://public.tableau.com/app/profile/oladimeji.olaniyan/viz/NigeriaCOVID-19Data/Dashboard1).  
